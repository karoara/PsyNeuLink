...
__all__ = [
    ...
    'CONROLLER_PHASE_SPEC', 'CONSTANT', 'CONSTANT_INTEGRATOR_FUNCTION', 'CONTEXT',
    'CONTRASTIVE_HEBBIAN_FUNCTION', 'CONTRASTIVE_HEBBIAN_MECHANISM',
    ...
    'CORRELATION', 'COST_FUNCTION', 'CROSS_ENTROPY', 'CUSTOM_FUNCTION', 'CYCLE',
...
CONTRASTIVE_HEBBIAN_FUNCTION = 'Contrastive Hebbian Learning Function'
