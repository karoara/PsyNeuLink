...
mySystem.add_prediction_learning([Flanker_Stim, Target_Stim, Reward], [0.3481, 0.3481, 0.3481])
...
# changed from rate --> smoothing factor because prediction mechanisms are now TransferMechanisms
# with Linear fn in integrator_mode -- NOT IntegratorMechanisms with AdaptiveIntegrator fn

# Flanker
mySystem.controller.prediction_mechanisms.mechanisms[0].smoothing_factor = 1.0
# Reward
mySystem.controller.prediction_mechanisms.mechanisms[1].smoothing_factor = 0.3481  # reward rate
# Target
mySystem.controller.prediction_mechanisms.mechanisms[2].smoothing_factor = 1.0
